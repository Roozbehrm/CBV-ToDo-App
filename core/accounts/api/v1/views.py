...
from .serializers import (RegistrationSerializer, CustomAuthTokenSerializer,
                          ...
                          ChangePasswordSerializer, ActivationResendSerializer, RequestPasswordResetSerializer, ResetPasswordConfirmApiSerializer, ValidatePasswordResetSerializer)
...
class RegistrationApiView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            email_msg = EmailMessage('email/user-activation.tpl', {'link': activation_link}, 'roozbehm.ir',
                       to=[email])
...
class ChangePasswordApiView(GenericAPIView):
    ...
    def put(self, request, *args, **kwargs):
            ...
            if serializer.is_valid():
                ...
                self.object.save()
                return Response({'datails': 'password changed successfully'}, status=status.HTTP_200_OK)
            return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class RequestPasswordResetApi(GenericAPIView):
    ...
    def post(self, request):
        ...
        if user:
            ...
            email_msg = EmailMessage('email/reset-password.tpl', {'link': reset_link}, 'roozbehm.ir',
                       to=[user.email])
            EmailThread(email_msg).start() 
...
class ResetPasswordConfirmApi(GenericAPIView):
    ...
    def get(self, request, uidb64, token):
        ...
        serializer = ValidatePasswordResetSerializer(data={'token': token, 'uidb64': uidb64})
        serializer.is_valid(raise_exception=True)
